...
using Task = Assignment16.Models.Task;
    ...
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Task != null ? 
                          ...
                          Problem("Entity set 'TaskDbContext.Task'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,DueDate")] Models.Task task)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TaskDbContext.Task'  is null.");
            }
            var task = await _context.Task.FindAsync(id);
            if (task != null)
            {
